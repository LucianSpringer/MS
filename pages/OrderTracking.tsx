                        ...
                        {[
                            ...
                            return (
                                <div key={idx} className={`flex md:flex-col items-start md:items-center gap-4 md:gap-2 relative z-10 ${isActive ? 'opacity-100' : 'opacity-50 grayscale'}`}>
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center border-4 transition-all duration-500 bg-white dark:bg-darkSurface shrink-0 ${
                                        isActive ? 'border-primary text-primary shadow-lg scale-110' : 'border-gray-200 dark:border-gray-700 text-gray-400'
                                    }`}>
                                        <item.icon size={18} />
                                    </div>
